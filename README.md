...
- **自動LaTeX変換**: 普通の数式テキスト（例: `y=sin(x)`, `y=|x|`, `y=(x+1)/(x-2)`）を自動でLaTeX形式に変換
...
```bash
# 基本関数
/gratex latex:y = x^2                 # 二次関数
/gratex latex:y = sin(x)              # 正弦波
/gratex latex:y = cos(x)              # 余弦波
/gratex latex:y = |x|                 # 絶対値関数
/gratex latex:y = sqrt(x)             # 平方根関数

# 分数・有理関数
/gratex latex:y = (x+1)/(x-2)         # 有理関数
/gratex latex:y = x/(x^2+1)           # 分数関数

# 幾何図形
/gratex latex:x^2 + y^2 = 25          # 円
/gratex latex:x^2/4 + y^2/9 = 1       # 楕円
/gratex latex:y^2 = 4*x               # 放物線

# 三角関数
/gratex latex:y = sin(x) + cos(x)     # 合成三角関数
/gratex latex:y = tan(x)              # 正接関数

# 複雑な関数
/gratex latex:y = sin(x)*cos(x)       # 積の三角関数
/gratex latex:y = |sin(x)|            # 絶対値と三角関数
```
